...
static uint8_t IsKeyDown0(void)     {if ((GPIO_PORT_K0->IDR & GPIO_PIN_K0) == 0) return 1;else return 0;}
static uint8_t IsKeyDown1(void)     {if ((GPIO_PORT_K1->IDR & GPIO_PIN_K1) == 0) return 1;else return 0;}
static uint8_t IsKeyDownWKUP(void)  {if ((GPIO_PORT_WKUP->IDR & GPIO_PIN_WKUP) == 0) return 0;else return 1;}
...
static void bsp_InitKeyVar(void)
{
	...
	s_tBtn[2].IsKeyDownFunc = IsKeyDownWKUP;
}
